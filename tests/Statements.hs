...
tests = test
  ...
  , "for1righterror" ~: "for(i = 0; i< 10; i i + 1)\n\treturn i;" |~?= For (Just (Assignment (Scalar "i") (LitInt 0)))
                                                                   (Just (Relative Less (Var (Scalar "i")) (LitInt 10)))
                                                                   (Just ErrorA)
                                                                   (Return (Just (Var (Scalar "i"))))
  , "for1middleerror" ~: "for(i = 0; 10+; i = i + 1)\n\treturn i;" |~?= For (Just (Assignment (Scalar "i") (LitInt 0)))
                                                                   (Just ErrorE)
                                                                   (Just (Assignment (Scalar "i") (Binary Plus (Var (Scalar "i")) (LitInt 1))))
                                                                   (Return (Just (Var (Scalar "i"))))
  , "for1allerror" ~: "for(i = 0 i10; i = i + 1)\n\treturn i;" |~?= For    (Just ErrorA)
                                                                   (Just ErrorE)
                                                                   (Just ErrorA)
                                                                   (Return (Just (Var (Scalar "i"))))
  , "for1firsterror" ~: "for(i   0; i< 10; i = i + 1)\n\treturn i;" |~?= For (Just ErrorA)
                                                                   (Just (Relative Less (Var (Scalar "i")) (LitInt 10)))
                                                                   (Just (Assignment (Scalar "i") (Binary Plus (Var (Scalar "i")) (LitInt 1))))
                                                                   (Return (Just (Var (Scalar "i"))))
